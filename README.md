...
| `entity:health`         | Returns the current health of an entity.                                |
| `entity:health/set`     | Sets the health value of an entity.                                     |
| `entity:inventory`      | Returns the inventory contents of a player or inventory-holding entity. |
| `entity:inventory/set`  | Modifies or replaces inventory contents.                                |
...
| `entity:saturation`     | Returns the food saturation level of a player.                          |
| `entity.saturation/set` | Sets the saturation level of a player.                                  |
