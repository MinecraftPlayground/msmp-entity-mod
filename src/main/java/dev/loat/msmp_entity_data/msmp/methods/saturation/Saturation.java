...
/**
 * Registers the {@code entity_data:saturation} MSMP method.
 *
 * <p>Returns the current food level and saturation of an online player.</p>
 *
 * <p>Example request:</p>
 * <pre>{@code
 * { "jsonrpc": "2.0", "id": 1, "method": "entity_data:saturation",
 *   "params": [{ "name": "Steve" }] }
 * }</pre>
 *
...
public class Saturation {
    ...
    /**
     * Registers the {@code entity_data:saturation} method on the given {@link MSMPNamespace}.
     *
        ...
        namespace.method("saturation",
            ...
            (server, params, client) -> {
                try {
                    ...
                    Logger.warning("entity_data:saturation - " + e.getMessage());
                    throw e;
                }
            }
        );
